...
import 'package:kiriapp/components/product_card.dart';
import 'package:kiriapp/components/rounded_icon_button.dart';
import 'package:kiriapp/components/search_field.dart';
...
import 'package:kiriapp/screens/search_result/search_result_screen.dart';
import 'package:kiriapp/services/data_streams/category_products_stream.dart';
  ...
  Widget buildHeadBar() {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child:
              Image.asset('../assets/images/iconlaunch.png'), // Text("KIRI"),
          // SearchField(
